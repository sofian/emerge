...
void setup() {
  ...
  Device.Signal out1 = dev.add_output("outsig1", 1, 'i', "Hz", new Double(0.0), new Double(1.0));
  ...
  Device.Signal inp2 = dev.add_hidden_input("insig2", 1, 'f', "Hz", new Double(2.0), null, 
  new InputListener() {
    public void onInput(float[] v) {
